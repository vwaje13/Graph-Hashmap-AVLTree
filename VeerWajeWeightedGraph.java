...
public class VeerWajeWeightedGraph<V>extends VeerWajeUnweightedGraph<V> {
  /** Construct an empty */
  public VeerWajeWeightedGraph() {
  }

  /** Construct a WeightedGraph from vertices and edged in arrays */
  public VeerWajeWeightedGraph(V[] vertices, int[][] edges) {
    createWeightedGraph(java.util.Arrays.asList(vertices), edges);
  }

  /** Construct a WeightedGraph from vertices and edges in list */
  public VeerWajeWeightedGraph(int[][] edges, int numberOfVertices) {
  ...
  public VeerWajeWeightedGraph(List<V> vertices, List<WeightedEdge> edges) {
    createWeightedGraph(vertices, edges);
  }

  /** Construct a WeightedGraph from vertices 0, 1, and edge array */
  public VeerWajeWeightedGraph(List<WeightedEdge> edges, int numberOfVertices) {
    List<V> vertices = new ArrayList<>();
    for (int i = 0; i < numberOfVertices; i++)
      vertices.add((V)(Integer.valueOf(i)));
